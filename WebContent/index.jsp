...
<!--// bootstrap-css -->
<!-- css -->
<link rel="stylesheet" href="css/indexStyle.css" type="text/css" media="all" />
...
<body>
							...
							<div class="agileinfo-dot">
								<div class="container">
									<div class="agileits-banner-info">
										<h3>Welcome to Dev Bank</h3>
										<h6>Utilize the best Service</h6>
										<div class="w3-button">
	...
	<div class="banner">
					...
					<div class="navbar-header">
					  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						...
						<div class="w3layouts-logo">
							<img src="images/logo.png" height="70px"width="150px">
						</div>
					</div>
		...
		<div class="header">
			<div class="container-fliud">
				<div class="row jbanking_row">			
							<!-- rajesh -->
				<div class="col-md-4 pull-right jbanking">
					<!-- list -->
					  <ul class="nav nav-pills nav-stacked col-md-4">
						<li><a data-toggle="pill" href="#login">Login</a></li>
						<li><a data-toggle="pill" href="#Register">Register</a></li>
                         <li><a data-toggle="pill" href="#Refernce">Track Refernce</a></li>
					  ...
					  <div class="tab-content col-md-7">
						<div id="login" class="tab-pane fade in active">
						  ...
						  <p><a href ="customerLogin.htm">Click here to login</a></p>
						</div>
						<div id="Register" class="tab-pane fade">
						  <h4>Welcome New user</h4>
						  <p><a href ="customer.htm"> click here to Register</a></p>
						</div>
					  <div id="Refernce" class="tab-pane fade">
						  <h4>Welcome to Track Your Application Status</h4>
						  <p><a href ="trackReferenceNumber.htm">Click here</a></p>
						</div>
	...
	<footer>
		<div class="container">
			<div class="copyright">
				<p>© 2017 Bank Online. All rights reserved | Design by <a href="http://mktechnosoft.com">MkTechnosoft</a></p>
			</div>
		</div>
	</footer>
	<!-- //copyright -->
...
<!-- FlexSlider -->
  ...
  <!-- <h1>Bank Name after this</h1> -->
 <%--  <% String bankname = (String) session.getAttribute("bank"); %>
  <%= bankname %> --%>
  <%= session.getAttribute("bank") %>
  <%--  <%= request.getAttribute("bank1") %>${requestScope} --%>
  <%-- <%= ${sessionScope.bank} %>
   <%= ${requestScope.bank} %> --%>
