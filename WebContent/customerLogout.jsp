...
<div class="col-md-4"><h3>Customer Logged Out</h3></div>
</div>
</div><!--end-row-->
<div class="row">
          ...
          <form:form>
		   <img src="images/banner.jpg" height="80px" width="100%;"><br><br>
            <div class="form-group">
                ...
                <h2>Customer Successfully Logged Out</h2>
             
            </div>
            
	<div class="row">
<span class="col-md-12 text-center"> <a href="index.jsp">Return to Home</a> </span>
